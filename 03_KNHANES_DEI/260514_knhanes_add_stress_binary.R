...
# BE3_75(고강도 신체활동 여부: 여가) 결측 제거
df_003 <- df_003 %>% filter(BE3_71 != 9)

# BE3_82(고강도 신체활동 일수: 여가) 빈도 확인
#df_003 %>% count(BE3_76)

# BE3_76(고강도 신체활동 일수: 여가) 결측 제거
