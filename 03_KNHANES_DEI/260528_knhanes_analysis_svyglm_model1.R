...
#   <chr>                        <dbl> <chr>     <dbl>  <dbl>
# 1 (Intercept)                  3.80  0.008    10.1    1.43 
# 2 성별여자                     2.26  < 0.001   3.51   1.46 
# 3 연령구분46이상               0.270 < 0.001   0.549  0.133
# 4 교육수준대졸이상             1.28  0.20      1.88   0.877
# 5 결혼여부기혼                 0.416 0.02      0.862  0.201
# 6 거주지역읍·면                1.02  0.93      1.52   0.685
# 7 경제활동상태예               1.35  0.15      2.02   0.895
# 8 중위가구소득이상             1.24  0.24      1.77   0.867
# 9 흡연자흡연자                 1.05  0.83      1.60   0.688
#10 고위험음주여부고위험군       1.52  0.11      2.52   0.914
#11 유산소실천여부실천           0.786 0.18      1.12   0.551
#12 스트레스인지많이인지         1.19  0.43      1.82   0.777
#13 범불안장애위험위험           1.27  0.39      2.21   0.735
#14 고혈압의사진단여부있음       1.76  0.002     2.50   1.24 
#15 이상지질혈증의사진단여부있음 1.22  0.30      1.80   0.835

# 일반 집단
summary_glm(set_df(df_non_diabetes_001, 'model1') %>% select(-비만여부), 'model1')
#   `Independent variables`         OR p_value CI_high CI_low
#   <chr>                        <dbl> <chr>     <dbl>  <dbl>
# 1 (Intercept)                  0.804 0.008     0.945  0.685
# 2 성별여자                     0.888 0.02      0.981  0.803
# 3 연령구분46이상               0.683 < 0.001   0.763  0.611
# 4 교육수준대졸이상             1.01  0.76      1.12   0.922
# 5 결혼여부기혼                 1.36  < 0.001   1.52   1.21 
# 6 거주지역읍·면                1.20  0.007     1.37   1.05 
# 7 경제활동상태예               1.06  0.29      1.17   0.953
# 8 중위가구소득이상             0.945 0.23      1.04   0.862
# 9 흡연자흡연자                 0.800 < 0.001   0.908  0.705
#10 고위험음주여부고위험군       1.22  0.004     1.40   1.07 
#11 유산소실천여부실천           0.968 0.48      1.06   0.883
#12 스트레스인지많이인지         1.31  < 0.001   1.47   1.18 
#13 범불안장애위험위험           1.05  0.47      1.21   0.915
#14 고혈압의사진단여부있음       2.14  < 0.001   2.49   1.83 
#15 이상지질혈증의사진단여부있음 1.46  < 0.001   1.68   1.27 